...
use http::uri::{ErrorKind, InvalidUri, Uri, URI_CHARS, Port };

//#[test]
pub fn test_char_table() {
...
//#[test]
pub fn test_uri_to_path_and_query() {
    let cases = vec![
        ("/", "/"),
        ("/foo?bar", "/foo?bar"),
...
//#[test]
pub fn test_authority_uri_parts_round_trip() {
    let s = "hyper.rs";
...
//#[test]
pub fn test_partial_eq_path_with_terminating_questionmark() {
    let a = "/path";
